...
Finally, pre-trained `weights <https://github.com/Nelson-Gon/cytounet/models/a549_scratch.hdf5>`_ are provided that can be used for transfer learning. These were trained on considerably more data
and for more epochs. 
